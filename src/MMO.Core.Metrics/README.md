...
```csharp
using MMO.Core.Metrics.Extensions;
...
Works alongside:
- `MMO.Core.RateLimit` - Exposes rate limiting statistics
- `MMO.Core.Idempotency` - Tracks duplicate request rates
- `MMO.Core.HybridCache` - Reports cache hit/miss ratios
