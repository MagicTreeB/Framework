...
```xml
<ProjectReference Include="..\..\..\Core\MagicTree.Framework.RateLimit\MagicTree.Framework.RateLimit.csproj" />
```
...
```csharp
using MagicTree.Framework.RateLimit.Extensions;
