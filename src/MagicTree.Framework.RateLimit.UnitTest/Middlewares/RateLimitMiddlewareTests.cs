...
using MagicTree.Framework.RateLimit.Middlewares;
using MagicTree.Framework.RateLimit.Models;
using System.Net;
using System.Security.Claims;
using System.Text.Json;

namespace MagicTree.Framework.RateLimit.UnitTest.Middlewares;
...
public class RateLimitMiddlewareTests
{
    ...
    {
        // Arrange
        var options = Microsoft.Extensions.Options.Options.Create(new MagicTree.Framework.RateLimit.Options.RateLimitOptions { Enabled = false });
    ...
    {
        // Arrange
        var options = Microsoft.Extensions.Options.Options.Create(new MagicTree.Framework.RateLimit.Options.RateLimitOptions 
        { 
            Enabled = true,
    ...
    public async Task InvokeAsync_UnderLimit_ShouldAllow()
    {
        ...
        { 
            Enabled = true,
            Global = new MagicTree.Framework.RateLimit.Options.RateLimitRule { Limit = 10, WindowSeconds = 60 }
        });
    ...
    public async Task InvokeAsync_ShouldAddRateLimitHeaders()
    {
        ...
        { 
            Enabled = true,
            Global = new MagicTree.Framework.RateLimit.Options.RateLimitRule { Limit = 10, WindowSeconds = 60 },
            Headers = new MagicTree.Framework.RateLimit.Options.RateLimitHeaders { IncludeHeaders = true }
        });
    ...
    public async Task InvokeAsync_EndpointSpecificRule_ShouldUseEndpointLimit()
    {
        ...
        { 
            Enabled = true,
            Global = new MagicTree.Framework.RateLimit.Options.RateLimitRule { Limit = 100, WindowSeconds = 60 },
            Endpoints = new Dictionary<string, MagicTree.Framework.RateLimit.Options.RateLimitRule>
            {
                { "/api/login", new MagicTree.Framework.RateLimit.Options.RateLimitRule { Limit = 5, WindowSeconds = 300 } }
            }
        });
