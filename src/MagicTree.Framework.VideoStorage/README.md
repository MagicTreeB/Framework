# MagicTree.Framework.VideoStorage
...
```xml
<ItemGroup>
  <ProjectReference Include="..\..\Core\MagicTree.Framework.VideoStorage\MagicTree.Framework.VideoStorage.csproj" />
</ItemGroup>
```
...
```csharp
using MagicTree.Framework.VideoStorage.Extensions;
