...
## Problem
MMO.Core.RabbitMQ package was built for RabbitMQ.Client 6.x but the project uses RabbitMQ.Client 7.0+, which has breaking API changes.
...
### **Option B: Upgrade MMO.Core.RabbitMQ to 7.x**
