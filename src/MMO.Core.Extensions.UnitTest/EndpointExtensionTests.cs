...
namespace MMO.Core.Extensions.UnitTest.EndpointExtensionTests
{
    public class EndpointExtensionTests
    {
        ...
        public void MapAllEndpoints_Should_DiscoverAndInvokeEndpointMethods()
        {
            ...
            // Act
            var result = app.MapAllEndpoints("MMO.Core.Extensions.UnitTest.TestEndpoints");
...
namespace MMO.Core.Extensions.UnitTest.TestEndpoints
{
