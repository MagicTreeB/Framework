...
namespace MagicTree.Framework.Idempotency.UnitTest.Middlewares;
...
public class IdempotencyMiddlewareTests
{
    ...
    {
        // Arrange
        var options = Microsoft.Extensions.Options.Options.Create(new MagicTree.Framework.Idempotency.Options.IdempotencyOptions 
        { 
            Enabled = false 
        });
