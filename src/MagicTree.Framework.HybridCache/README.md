# MagicTree.Framework.HybridCache
...
```xml
<ProjectReference Include="..\..\..\Core\MagicTree.Framework.HybridCache\MagicTree.Framework.HybridCache.csproj" />
```
...
### Program.cs Setup
```csharp
using MagicTree.Framework.HybridCache.Extensions;
...
- Rate limiting counters (use MagicTree.Framework.RateLimit)
- Idempotency tracking (use MagicTree.Framework.Idempotency)

## Integration with Other Packages

| Package | Purpose | Storage | Use Case |
|---------|---------|---------|----------|
| **MagicTree.Framework.HybridCache** | Query result caching | InMemory + Redis | Read-heavy queries |
| **MagicTree.Framework.RateLimit** | Request throttling | InMemory or Redis | API protection |
| **MagicTree.Framework.Idempotency** | Duplicate prevention | InMemory or Redis | Write operations |
...
- [MagicTree.Framework.Idempotency Package](../MagicTree.Framework.Idempotency/README.md)
