# MMO.Core.Services - JWT Service Documentation

**Date**: December 21, 2025  
**Package**: MMO.Core.Services  
...
- **Middleware Dependency**: Requires `MMO.Core.Middlewares` with JWT middleware
...
### Project References
```xml
<ProjectReference Include="..\MMO.Core.Middlewares\MMO.Core.Middlewares.csproj" />
```
...
```csharp
using MMO.Core.Services.Extensions;
...
- `Core/MMO.Core.Middlewares/Jwt/JWT-QUICK-REFERENCE.md` - JWT Middleware
- `Core/MMO.Core.Middlewares/MultiTenancy/README.md` - Multi-tenancy with OrganizationId
